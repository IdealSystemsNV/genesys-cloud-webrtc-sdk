...
import { IPendingSession, IStartSessionParams, IAcceptSessionRequest, ISessionMuteRequest, IExtendedMediaSession, IUpdateOutgoingMedia, IConversationHeldRequest, IActiveConversationDescription } from '../types/interfaces';
export default abstract class BaseSessionHandler {
    ...
    startSession(sessionStartParams: IStartSessionParams): Promise<any>;
    handlePropose(pendingSession: IPendingSession): Promise<any>;
    proceedWithSession(session: IPendingSession): Promise<any>;
    rejectPendingSession(session: IPendingSession): Promise<any>;
    handleSessionInit(session: IExtendedMediaSession): Promise<any>;
    /**
   ...
   */
    ...
    setVideoMute(session: IExtendedMediaSession, params: ISessionMuteRequest): Promise<any>;
