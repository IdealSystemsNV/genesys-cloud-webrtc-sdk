...
import { IPendingSession, ISessionInfo, IEndSessionRequest, IStartSessionParams, IAcceptSessionRequest, ISessionMuteRequest, IUpdateOutgoingMedia, IStartVideoSessionParams, IExtendedMediaSession, IStartSoftphoneSessionParams, ISessionIdAndConversationId, IConversationHeldRequest, IPendingSessionActionParams, IActiveConversationDescription } from '../types/interfaces';
...
export declare class SessionManager {
    ...
    startSession(startSessionParams: IStartSessionParams | IStartVideoSessionParams | IStartSoftphoneSessionParams): Promise<any>;
    /**
     * Update the outgoing media for a session.
     *
     * @param options for updating outgoing media
     */
    updateOutgoingMedia(options: IUpdateOutgoingMedia): Promise<any>;
    updateOutgoingMediaForAllSessions(options?: Pick<IUpdateOutgoingMedia, 'audioDeviceId' | 'videoDeviceId'>): Promise<any>;
    updateAudioVolume(volume: number): void;
    updateOutputDeviceForAllSessions(outputDeviceId: string | boolean | null): Promise<any>;
    ...
    onSessionInit(session: IExtendedMediaSession): Promise<any>;
    acceptSession(params: IAcceptSessionRequest): Promise<any>;
